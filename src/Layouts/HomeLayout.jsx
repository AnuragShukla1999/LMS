...
function HomeLayout({ children }) {
    ...
    return (
        <div className="min-h-[90vh] ">
            <div className="drawer relative left-0 bottom-0 z-50 w-fit">
                ...
                <div className='drawer-side '>
                    <label htmlFor="my-drawer" className='drawer-overplay'>

                    </label>
                    <ul className="menu p-4 w-48 sm:w-80 h-60 bg-base-300 text-base-content relative">
